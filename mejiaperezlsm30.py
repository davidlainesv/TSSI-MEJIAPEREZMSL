...
_DESCRIPTION = """
MejiaPerezMSL30 is a 30-label video dataset for Isolated Mexican Sign Language (ASL) recognition.
...
class MejiaPerezMsl30(tfds.core.GeneratorBasedBuilder):
    """DatasetBuilder for mejiaperezmsl30 dataset."""
